...
PORT="${PORT:-5810}"
DB_NAME="${PGDATABASE:-newsletter_community_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Newsletter Community Operations Suite"
echo "======================================="
echo
...
echo "Starting newsletter community operations suite frontend on http://localhost:$PORT"
echo "Login: admin@newsletter-community-operations.local / admin123"
