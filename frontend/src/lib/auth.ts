export const AUTH_COOKIE = 'newsletter_community_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@newsletter-community-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@newsletter-community-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@newsletter-community-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
